...
set(ALL_LIBGRPC ${LIBGPR} ${LIBGRPC} ${LIBGRPCPP} ${LIBGRPC_CRONET}
    ${LIBGRPCPP_CRONET} ${LIBGRPCPP_ERROR_DETAILS} ${LIBGRPC_PLUGIN_SUPPORT}
    ${LIBGRPCPP_REFLECTION} ${LIBGRPC_UNSECURE} ${LIBGRPCPP_UNSECURE} ${LIBZ})
