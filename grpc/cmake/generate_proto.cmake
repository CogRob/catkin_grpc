...
set(ALL_GRPC_LIBS ${LIBADDRESS_SORTING} ${LIBARES} ${LIBBORINGSSL} ${LIBGPR} ${LIBGRPC} ${LIBGRPCPP}
    ${LIBGRPC_ABSEIL} ${LIBGRPCPP_ALTS} ${LIBGRPCPP_ERROR_DETAILS} ${LIBGRPCPP_CHANNELZ}
    ${LIBGRPC_PLUGIN_SUPPORT} ${LIBGRPCPP_REFLECTION} ${LIBGRPC_UNSECURE} ${LIBGRPCPP_UNSECURE})
